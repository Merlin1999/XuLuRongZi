...
namespace KT.Utility.Files
{
    ...
    public static class XmlHelper
    {
        ...
        /// <param name="standalone">该值必须是"yes"或"no",如果为null,Save方法不在XML声明上写出独立属性</param>
        /// <returns>成功返回true,失败返回false</returns>
        public static bool CreateXmlDocumentStanderd(string xmlFileName, string rootNodeName, string version, string encoding, string standalone)
        {
            bool isSuccess = false;
            try
            {
                ...
                xmlDoc.AppendChild(xmlDeclaration);
                xmlDoc.AppendChild(root);
                AddEleAttr(root, xmlDoc, "xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance");
                AddEleAttr(root, xmlDoc, "xmlns:xsd", "http://www.w3.org/2001/XMLSchema"); 
